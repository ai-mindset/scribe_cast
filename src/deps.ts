...
// Third-party imports
export { extractText, extractImages, getResolvedPDFJS } from "unpdf";
...
export const CONFIG = {
    ...
    VECTOR_SIZE: 4096,
    STREAM: true,
    PARSING_CACHE: "./data/cache.json", // https://github.com/run-llama/ts-agents/blob/main/5_qdrant/agent.ts
} as const;
